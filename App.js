ubuntu@ip-172-31-15-252:~/packt3/src$ cat App.js
...
class App extends Component {
        ...
        async loadBlockchainData(){
                ...
                const web3 = new Web3(new Web3.providers.HttpProvider("http://ec2-54-212-188-52.us-west-2.compute.amazonaws.com:8545"))
                var account;
...
// does not work right now - have to read in automatic
                ...
                contract.options.address = "0xd17a84C7E944565652A62a644c225675A09f636F";
                ...
                await contract.methods.voteForCandidate(web3.utils.asciiToHex('Johnny')).send({gas: 140000, from: '0x9B6ce252377A4B7517AED61B49B566A6F2B76Fb3'});
